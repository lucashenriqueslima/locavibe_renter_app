        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            body: AppPageViewWidget(children: [
              firstStep(controller),
              secondStep(controller),
            ]),
          ),
        ),
      ),
...
Widget firstStep(LoginController controller) {
...
Widget secondStep(LoginController controller) {
  return SingleChildScrollView(
    child: SafeArea(
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // Obx(
            //   () => controller.secondsForResend > 0
            //       ? Text(
            //           "Reenviar código em ${controller.secondsForResend.value} segundos",
            //           style: context.textStyles.textBold.copyWith(
            //             fontSize: 16,
            //           ),
            //         )
            //       : TextButton(
            //           onPressed: () => controller.sendEmailWihToken(),
            //           child: Text(
            //             "Reenviar código",
            //             style: context.textStyles.textBold.copyWith(
            //                 fontSize: 16, color: context.primary),
            //           ),
            //         ),
            // ),
